...
(266-270) Η τελευταία pattern μπορεί να χρησιμοποιηθεί και από τα προηγούμενα synth, αν τους προστεθεί ένα EnvGen που επιτρέπει την απελευθέρωσή τους μετά το κλείσιμο της περιβάλλουσας μέσω του doneAction: 0, όπως γίνεται στο παραπάνω synth \Hayperc.        
