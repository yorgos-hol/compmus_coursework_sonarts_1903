...
Σ'αυτό το σημείο πρέπει να σημειωθεί ότι μία μέθοδος συμπλήρωσης wavetable δεν εφαρμόστηκε στην παρούσα εργασία, καθώς προτιμήθηκε η διαισθητικότερη παραγωγή κυματομορφών, αλλά κυρίως η χρήση συγκεκριμένων sample. Η μη περιλαμβανόμενη μέθοδος είναι ο προγραμματισμός κυματομορφής μέσω envelope generator στο supercollider (παράδειγμα: 
(
~env = Env.new(
	{rrand(-1.0,1.0)}!11,
	{exprand(0.001,3)}!10,
