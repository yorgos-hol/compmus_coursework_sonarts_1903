...
Κάτι που αποφεύχθηκε είναι το γράψιμο συνάρτησης μεταφοράς βάσει απόλυτα συγκεκριμένων, ήδη γνωστών και υπολογισμένων μαθηματικών υπολογισμών π.χ. παραγωγής ημιτονοειδούς κύματος (βλ. τριγωνομετρία, πολυώνυμα Chebyshev - για τα οποία μάλιστα υπάρχει έτοιμη μέθοδος για wavetable synthesis στο Supercollider κτλ.). Παράδειγμα:
````
(
