...
Στο συγκεκριμένο αλλά και στο επόμενο synth, τα ευρετήρια και η ενίσχυση του σήματος έχουν εναλλακτικές επιλογές. Η ενίσχυση συγκεκριμένα μπορεί να εξαρτάται είτε από την εκάστοτε συχνότητα συντονισμού, είτε από την - μη εναλλασσόμενη σε πραγματικό χρόνο - ποιότητα των φίλτρων του κάθε ταλαντωτή.
