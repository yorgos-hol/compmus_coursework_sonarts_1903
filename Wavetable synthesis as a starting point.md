...
(203-226) Το παραπάνω synth μετατρέπεται σε ένα πολυ-synth με πολυρυθμική υφή και μικρογεγονότα που συμβαίνουν στα διάφορα, κολλημένα το ένα στο άλλο, στρώματά του. 
